...
def mine_block():
    ...
    print(tex)
    blockchain.add_transaction(text = tex)
...
def add_transaction():
    ...
    transaction_keys = ['IssuingAuthority', 'Receipient', 'Degree']
    if not all(key in json for key in transaction_keys):
        return 'Some elements of the transaction are missing', 400
    index = blockchain.add_transaction(json['IssuingAuthority'], json['Receipient'], json['Degree'])
...
if __name__=="__main__":
    app.run(host="192.168.50.234",port="5003")
